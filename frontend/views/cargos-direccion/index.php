...
/* @var $searchModel frontend\models\CargosDireccionSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Cargos Direccions');
$this->params['breadcrumbs'][] = $this->title;
$this->params['tittle'][] = $this->title;
?>
<div class="cargos-direccion-index">
    ...
    <?= 
        ...
        'panel' => [
        'heading'=>'<h3 class="panel-title"><i class="glyphicon glyphicon-list"></i> Cargos de Dirección</h3>',
        'type'=>'primary',
