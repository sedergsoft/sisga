...
$this->title = Yii::t('app', 'Graficos de Ventas Liberadas');
...
?>
  ...
  <div style="display: none"> 
   ...
   $sqlVillaClara = 'SELECT DISTINCT producto.producto,ventas.vreal, empresa.nombre,empresa.id, tipo_venta.tipo_venta,MONTH(ventas.fecha) as fecha FROM ventas, empresa,tipo_venta, producto WHERE empresa.id = ventas.empresaid and ventas.empresaid=17 AND ventas.tipo_ventaid = tipo_venta.id AND ventas.tipo_ventaid = 3 AND ventas.productoid = producto.id order by fecha  DESC    ';
  ...
  $sqlart = 'SELECT DISTINCT producto.producto,ventas.vreal, empresa.nombre,empresa.id, tipo_venta.tipo_venta,MONTH(ventas.fecha) as fecha FROM ventas, empresa,tipo_venta, producto WHERE empresa.id = ventas.empresaid and ventas.empresaid=12 AND ventas.tipo_ventaid = tipo_venta.id AND ventas.tipo_ventaid = 3 AND ventas.productoid = producto.id order by fecha  DESC    ';
  ...
  if($rawDataart)
   ...
   $sqlmay = 'SELECT DISTINCT producto.producto,ventas.vreal, empresa.nombre,empresa.id, tipo_venta.tipo_venta,MONTH(ventas.fecha) as fecha FROM ventas, empresa,tipo_venta, producto WHERE empresa.id = ventas.empresaid and ventas.empresaid=13 AND ventas.tipo_ventaid = tipo_venta.id AND ventas.tipo_ventaid = 3 AND ventas.productoid = producto.id order by fecha  DESC    ';
  ...
  if($rawDatamay)
   ...
   $sqllah = 'SELECT DISTINCT producto.producto,ventas.vreal, empresa.nombre,empresa.id, tipo_venta.tipo_venta,MONTH(ventas.fecha) as fecha FROM ventas, empresa,tipo_venta, producto WHERE empresa.id = ventas.empresaid and ventas.empresaid=14 AND ventas.tipo_ventaid = tipo_venta.id AND ventas.tipo_ventaid = 3 AND ventas.productoid = producto.id order by fecha  DESC    ';
  ...
  if($rawDatalah)
   ...
   $sqlmat = 'SELECT DISTINCT producto.producto,ventas.vreal, empresa.nombre,empresa.id, tipo_venta.tipo_venta,MONTH(ventas.fecha) as fecha FROM ventas, empresa,tipo_venta, producto WHERE empresa.id = ventas.empresaid and ventas.empresaid=15 AND ventas.tipo_ventaid = tipo_venta.id AND ventas.tipo_ventaid = 3 AND ventas.productoid = producto.id order by fecha  DESC    ';
  ...
  $sqlcie = 'SELECT DISTINCT producto.producto,ventas.vreal, empresa.nombre,empresa.id, tipo_venta.tipo_venta,MONTH(ventas.fecha) as fecha FROM ventas, empresa,tipo_venta, producto WHERE empresa.id = ventas.empresaid and ventas.empresaid=16 AND ventas.tipo_ventaid = tipo_venta.id AND ventas.tipo_ventaid = 3 AND ventas.productoid = producto.id order by fecha  DESC    ';
  ...
  $sqlsant = 'SELECT DISTINCT producto.producto,ventas.vreal, empresa.nombre,empresa.id, tipo_venta.tipo_venta,MONTH(ventas.fecha) as fecha FROM ventas, empresa,tipo_venta, producto WHERE empresa.id = ventas.empresaid and ventas.empresaid=18 AND ventas.tipo_ventaid = tipo_venta.id AND ventas.tipo_ventaid = 3 AND ventas.productoid = producto.id order by fecha  DESC    ';;
  ...
  if($rawDatasant)
   ...
   $sqlcieg = 'SELECT DISTINCT producto.producto,ventas.vreal, empresa.nombre,empresa.id, tipo_venta.tipo_venta,MONTH(ventas.fecha) as fecha FROM ventas, empresa,tipo_venta, producto WHERE empresa.id = ventas.empresaid and ventas.empresaid=19 AND ventas.tipo_ventaid = tipo_venta.id AND ventas.tipo_ventaid = 3 AND ventas.productoid = producto.id order by fecha  DESC    ';
  ...
  if($rawDatacieg)
   ...
   $sqlcam = 'SELECT DISTINCT producto.producto,ventas.vreal, empresa.nombre,empresa.id, tipo_venta.tipo_venta,MONTH(ventas.fecha) as fecha FROM ventas, empresa,tipo_venta, producto WHERE empresa.id = ventas.empresaid and ventas.empresaid=20 AND ventas.tipo_ventaid = tipo_venta.id AND ventas.tipo_ventaid = 3 AND ventas.productoid = producto.id order by fecha  DESC    ';
  ...
  if($rawDatacam)
   ...
   $sqllat = 'SELECT DISTINCT producto.producto,ventas.vreal, empresa.nombre,empresa.id, tipo_venta.tipo_venta,MONTH(ventas.fecha) as fecha FROM ventas, empresa,tipo_venta, producto WHERE empresa.id = ventas.empresaid and ventas.empresaid=21 AND ventas.tipo_ventaid = tipo_venta.id AND ventas.tipo_ventaid = 3 AND ventas.productoid = producto.id order by fecha  DESC    ';
  ...
  if($rawDatahol)
   ...
   $sqlgra = 'SELECT DISTINCT producto.producto,ventas.vreal, empresa.nombre,empresa.id, tipo_venta.tipo_venta,MONTH(ventas.fecha) as fecha FROM ventas, empresa,tipo_venta, producto WHERE empresa.id = ventas.empresaid and ventas.empresaid=22 AND ventas.tipo_ventaid = tipo_venta.id AND ventas.tipo_ventaid = 3 AND ventas.productoid = producto.id order by fecha  DESC    ';
  ...
  if($rawDatagra)
   ...
   $sqlsan = 'SELECT DISTINCT producto.producto,ventas.vreal, empresa.nombre,empresa.id, tipo_venta.tipo_venta,MONTH(ventas.fecha) as fecha FROM ventas, empresa,tipo_venta, producto WHERE empresa.id = ventas.empresaid and ventas.empresaid=23 AND ventas.tipo_ventaid = tipo_venta.id AND ventas.tipo_ventaid = 3 AND ventas.productoid = producto.id order by fecha  DESC    ';
  ...
  if($rawDatasan)
   ...
   $sqlgua = 'SELECT DISTINCT producto.producto,ventas.vreal, empresa.nombre,empresa.id, tipo_venta.tipo_venta,MONTH(ventas.fecha) as fecha FROM ventas, empresa,tipo_venta, producto WHERE empresa.id = ventas.empresaid and ventas.empresaid=24 AND ventas.tipo_ventaid = tipo_venta.id AND ventas.tipo_ventaid = 3 AND ventas.productoid = producto.id order by fecha  DESC    ';
  ...
  if($rawDatagua)
   ...
   $sqlisl = 'SELECT DISTINCT producto.producto,ventas.vreal, empresa.nombre,empresa.id, tipo_venta.tipo_venta,MONTH(ventas.fecha) as fecha FROM ventas, empresa,tipo_venta, producto WHERE empresa.id = ventas.empresaid and ventas.empresaid=25 AND ventas.tipo_ventaid = tipo_venta.id AND ventas.tipo_ventaid = 3 AND ventas.productoid = producto.id order by fecha  DESC    ';
  ...
  if($rawDataisl)
   ...
   $sqlasg = 'SELECT DISTINCT producto.producto,ventas.vreal, empresa.nombre,empresa.id, tipo_venta.tipo_venta,MONTH(ventas.fecha) as fecha FROM ventas, empresa,tipo_venta, producto WHERE empresa.id = ventas.empresaid and ventas.empresaid=26 AND ventas.tipo_ventaid = tipo_venta.id AND ventas.tipo_ventaid = 3 AND ventas.productoid = producto.id order by fecha  DESC    ';
  ...
  if($rawDataasg)
   ...
   $sqltcf = 'SELECT DISTINCT producto.producto,ventas.vreal, empresa.nombre,empresa.id, tipo_venta.tipo_venta,MONTH(ventas.fecha) as fecha FROM ventas, empresa,tipo_venta, producto WHERE empresa.id = ventas.empresaid and ventas.empresaid=27 AND ventas.tipo_ventaid = tipo_venta.id AND ventas.tipo_ventaid = 3 AND ventas.productoid = producto.id order by fecha  DESC    ';
  ...
  $sqlenf = 'SELECT DISTINCT producto.producto,ventas.vreal, empresa.nombre,empresa.id, tipo_venta.tipo_venta,MONTH(ventas.fecha) as fecha FROM ventas, empresa,tipo_venta, producto WHERE empresa.id = ventas.empresaid and ventas.empresaid=28 AND ventas.tipo_ventaid = tipo_venta.id AND ventas.tipo_ventaid = 3 AND ventas.productoid = producto.id order by fecha  DESC    ';
  ...
  if($rawDataenf)
   ...
   $sqlemmp = 'SELECT DISTINCT producto.producto,ventas.vreal, empresa.nombre,empresa.id, tipo_venta.tipo_venta,MONTH(ventas.fecha) as fecha FROM ventas, empresa,tipo_venta, producto WHERE empresa.id = ventas.empresaid and ventas.empresaid=29 AND ventas.tipo_ventaid = tipo_venta.id AND ventas.tipo_ventaid = 3 AND ventas.productoid = producto.id order by fecha  DESC    ';
  ...
  if($rawDataemmp)
   ...
   $sqlunal = 'SELECT DISTINCT producto.producto,ventas.vreal, empresa.nombre,empresa.id, tipo_venta.tipo_venta,MONTH(ventas.fecha) as fecha FROM ventas, empresa,tipo_venta, producto WHERE empresa.id = ventas.empresaid and ventas.empresaid=30 AND ventas.tipo_ventaid = tipo_venta.id AND ventas.tipo_ventaid = 3 AND ventas.productoid = producto.id order by fecha  DESC    ';
