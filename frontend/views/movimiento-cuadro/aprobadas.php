...
$this->title = Yii::t('app', 'Propuestas de Movimientos Aprobadas');
...
<div class="movimiento-cuadro-index">
    ...
    <?= GridView::widget([
        ...
        'panel' => [
        'heading'=>'<h3 class="panel-title"><i class="glyphicon glyphicon-list"></i> Propuestas de Movimientos Aprobadas </h3>',
        'type'=>'success',
