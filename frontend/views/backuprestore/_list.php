...
<div class="row">
    <div class="col-md-12">
        ...
        kartik\grid\GridView::widget([
            ...
            'hover' => true,
            'panel' => [
                'heading' => '<h3 class="panel-title"> Salvas de Base de datos</h3>',
                'type' => 'primary',
                'showFooter' => false
            ],
            // set your toolbar
            'toolbar' => [
                ['content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i>  Crear  ', ['create'], ['class' => 'btn btn-success create-backup margin-right5'])
                ],
            ],
            'columns' => array(
                'name',
