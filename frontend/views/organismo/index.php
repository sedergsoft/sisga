...
/* @var $searchModel frontend\models\OrganismoSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Organismos');
...
<div class="organismo-index">
    ...
    <?= GridView::widget([ 'dataProvider' => $dataProvider,
        ...
        'panel' => [
        'heading'=>'<h3 class="panel-title"><i class="glyphicon glyphicon-list"></i> Organismos</h3>',
        'type'=>'primary',
