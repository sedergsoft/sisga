...
$this->title = Yii::t('app', 'Editar preparación militar de : {name}', [
...
$this->params['breadcrumbs'][] = Yii::t('app', 'Editar preparación militar');
$this->params['tittle'][] = $this->title;
?>
<div class="preparacion-militar-update">
