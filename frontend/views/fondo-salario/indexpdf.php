...
/* @var $searchModel frontend\models\FondoSalarioSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Gasto de Salario por peso de Valor Agragado');
...
<div class="fondo-salario-index">
    ...
    <?= GridView::widget([
      ...
      //  'pjax'=>true,
        'striped'=>true,
        'hover'=>true,
        'panel'=>['type'=>'success', 'heading'=>'Anexo Gasto de Salario por peso de Valor Agragado'],
        /*'exportConfig'=>[
